...
<<<<<<< HEAD
        ...(planHasProfessor ? [{ label: "Config. Professor", href: "/professor-config", icon: <ProfessorIcon className="h-[18px] w-[18px]" />, roles: ["ADMIN"], tag: "IA" }] : []),
=======
        { label: "Config. Professor", href: "/professor-config", icon: <ProfessorIcon className="h-[18px] w-[18px]" />, roles: ["ADMIN"], tag: "IA" },
>>>>>>> 9708f50 (feat: descrição do que fez)
