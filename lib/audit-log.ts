...
export const AUDIT_ACTIONS = {
  ...
  // Multitracks
  MULTITRACK_RENTED: "MULTITRACK_RENTED",
  MULTITRACK_CATALOGED: "MULTITRACK_CATALOGED",
  MULTITRACK_UPDATED: "MULTITRACK_UPDATED",
  MULTITRACK_DOWNLOAD_STARTED: "MULTITRACK_DOWNLOAD_STARTED",
  // Splits
  SPLIT_CREATED: "SPLIT_CREATED",
  SPLIT_PURCHASED: "SPLIT_PURCHASED",
  SPLIT_MARKED_PUBLIC: "SPLIT_MARKED_PUBLIC",
  // Billing
