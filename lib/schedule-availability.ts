...
const buildAvailabilitySet = (availability: unknown[] | string[] | null | undefined) =>
  new Set((availability ?? []).map((day) => normalizeWeekday(String(day ?? ""))));

export const isAvailableOnWeekday = (availability: unknown[] | string[] | null | undefined, weekday: string) => {
