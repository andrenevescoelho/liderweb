...
export const PERMISSIONS: PermissionDefinition[] = [
  ...
  { key: "custom.mix.view", label: "Acessar Custom Mix", category: "technical", premium: true },
  { key: "coach.config.manage", label: "Configurar Professor IA", category: "administrative" },
